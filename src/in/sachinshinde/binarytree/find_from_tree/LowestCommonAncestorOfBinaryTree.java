...
public class LowestCommonAncestorOfBinaryTree {
  ...
  public static void main(String args[]) {
    ...
    */
    ...
    Node resultNode =
        tree.lowestCommonAncestor(root, root.left.left.left, root.left.right.right.right);

    System.out.println(resultNode.key); // 	2

    resultNode = tree.lowestCommonAncestor(root, root.left.left.right, root.right.left);

    System.out.println(resultNode.key); // 	1

    resultNode = tree.lowestCommonAncestor(root, root.left.right.left.right, root.left.right.right);
