...
public class LevelOrderTreeTraversalInSpiralEdgeForm {
  ...
  private static void printLevelwiseSpriralTree(Node root) {
    ...
    while (!s1.isEmpty() || !s2.isEmpty()) {
      ...
      if (evenLevel) {
        if (l1.size() >= 1) System.out.print(" " + l1.get(0));
        if (l1.size() >= 1 && l1.get(0) != l1.get(l1.size() - 1))
          System.out.print(" " + l1.get(l1.size() - 1));
        if (l2.size() >= 1) System.out.print(" " + l2.get(0));
        if (l2.size() >= 1 && l2.get(0) != l2.get(l2.size() - 1))
          System.out.print(" " + l2.get(l2.size() - 1));
      } else {
        if (l1.size() >= 1 && l1.get(0) != l1.get(l1.size() - 1)) System.out.print(" " + l1.get(0));
        if (l1.size() >= 1) System.out.print(" " + l1.get(l1.size() - 1));
        if (l2.size() >= 1 && l2.get(0) != l2.get(l2.size() - 1)) System.out.print(" " + l2.get(0));
        if (l2.size() >= 1) System.out.print(" " + l2.get(l2.size() - 1));
      }
