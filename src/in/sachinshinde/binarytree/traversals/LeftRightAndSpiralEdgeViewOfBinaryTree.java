...
public class LeftRightAndSpiralEdgeViewOfBinaryTree {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 1; i < spiralEdgeViewCount; i++) {
      if (i < leftViewResult.size()) spiralEdgeView.add(leftViewResult.get(i));
      if (i < rightViewResult.size()) spiralEdgeView.add(rightViewResult.get(i));
    }
    spiralEdgeView.forEach(
        k -> {
          System.out.print(" " + k);
        });
  }
