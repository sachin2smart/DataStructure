...
-----------
    ...
    Anti-Clockwise Spiral Edge View Of Binary Tree : [1, 8, 10, 3, 2, 4, 7]

    --------------------------------------------------------------------------------------

    Given: Root of a Binary Tree
    Return: List of Node values viewed from Anti-Clockwise Spiral Edge View Of Binary Tree

 */

public class AntiClockwiseSpiralEdgeViewOfBinaryTree {
    ...
    private List<Integer> antiClockwiseSpiralEdgeView(Node root) {
        int i = 1;
    ...
    public static void main(String[] args) {
        AntiClockwiseSpiralEdgeViewOfBinaryTree tree = new AntiClockwiseSpiralEdgeViewOfBinaryTree();
        ...
        List<Integer> result = tree.antiClockwiseSpiralEdgeView(root);
        System.out.println("Anti-Clockwise Spiral Edge View of Binary Tree : " + result);
        //  [1, 8, 10, 3, 2, 4, 7]
    }
}
