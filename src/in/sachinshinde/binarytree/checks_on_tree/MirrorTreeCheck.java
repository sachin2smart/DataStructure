...
public class MirrorTreeCheck {
  ...
  static boolean areMirrorTree(Node a, Node b) {
    ...
    return a.key == b.key && areMirrorTree(a.left, b.right) && areMirrorTree(a.right, b.left);
  }
  ...
  public static void main(String[] args) {
    ...
    if (areMirrorTree(a, b)) System.out.println("Both trees are mirror of each other");
    else System.out.println("Not mirror tree.");
  }
}
