...
public class CheckBinaryTreeIsBST {
  ...
  public static void main(String[] args) {
    ...
    //	Method : 1
    if (isBST(root)) System.out.print("Is BST");
    else System.out.print("Not a BST");

    //	Method : 2
    System.out.print("\n");
    if (isValidBST(root)) System.out.print("Is BST");
    else System.out.print("Not a BST");
  }
