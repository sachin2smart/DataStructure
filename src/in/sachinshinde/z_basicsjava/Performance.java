...
public class Performance {
  ...
  private void checkArraysCollectionSortPerformance() {
    ...
    */
    ...
    Arrays.sort(names);
    System.out.println(
        Arrays.toString(names)); // Output: Sorted Array: [Alice, Bob, David, Eve, John]
    ...
    Arrays.parallelSort(
        numbers); //  uses the Fork/Join framework for parallelism; speeding up the sorting process
    // for large arrays
