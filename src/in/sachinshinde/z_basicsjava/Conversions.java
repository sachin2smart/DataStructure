...
public class Conversions {
  ...
  public static void main(String[] args) {
    ...
    //		List<Integer> al11 = new ArrayList(Arrays.asList(arrInt)); // ** DO NOT Store int as Integer
    // in List, use below 2 ways
    List<Integer> al2 =
        new ArrayList<Integer>(
            Arrays.asList(Arrays.stream(arrInt).boxed().toArray(Integer[]::new)));
    List<Integer> al3 =
        new ArrayList<Integer>(Arrays.asList(IntStream.of(arrInt).boxed().toArray(Integer[]::new)));
    System.out.println("\n 3. Array to ArrayList conversion");
    ...
    //		List<Integer> ll11 = new LinkedList(Arrays.asList(arrInt)); // ** DO NOT Store int as
    // Integer in List, use below 2 ways
    List<Integer> ll2 =
        new LinkedList<Integer>(
            Arrays.asList(Arrays.stream(arrInt).boxed().toArray(Integer[]::new)));
    List<Integer> ll3 =
        new LinkedList<Integer>(
            Arrays.asList(IntStream.of(arrInt).boxed().toArray(Integer[]::new)));
    System.out.println("\n 4. Array to LinkedList conversion");
    ...
    System.out.println(
        Arrays.toString(nums)); // [25, 2, 1, 10] the combination 252110 creates the max number

    String[] nums2 = {"1", "10", "2", "25"};
    Arrays.sort(nums2, (String s1, String s2) -> (s1 + s2).compareTo(s2 + s1));
    System.out.println(
        Arrays.toString(
            nums2)); // [10, 1, 2, 25] the combination 101225 creates the smallest number
