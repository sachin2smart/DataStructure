...
public class FractionalShares {
  ...
  */
  ...
  //    private static void handleBuyOrder(Map<String, Integer> inventoryMap, String symbol, int
  // quantityRequired) {
  ...
  //                inventoryMap.put(symbol, 100 * (quantityRequired / 100 + 1) - (quantityRequired
  // - currentInventory));
  //            }
  //            else {
  ...
  //    private static void handleSellOrder(Map<String, Integer> inventoryMap, String symbol, int
  // quantityRequired) {
  //        int currentInventory = inventoryMap.get(symbol);
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        Arrays.deepToString(
            fractionalShares.updateInventory(
                new String[][] {
                  {"APPL", "B", "150", "100"},
                  {"APPL", "B", "40", "100"},
                  {"APPL", "B", "50", "100"}
    ...
    System.out.println(
        Arrays.deepToString(fractionalShares.updateInventory(orders, inventory))); //  [[AAPL, 57]]
    //
    orders = new String[][] {{"AAPL", "B", "$42", "100"}};
    inventory = new String[][] {{"AAPL", "50"}};
    System.out.println(
        Arrays.deepToString(fractionalShares.updateInventory(orders, inventory))); //  [[AAPL, 8]]
    //
    orders = new String[][] {{"AAPL", "B", "42", "50"}};
    inventory = new String[][] {{"AAPL", "19"}};
    System.out.println(
        Arrays.deepToString(fractionalShares.updateInventory(orders, inventory))); //  [[AAPL, 77]]

    //        orders = new String[][] {{"AAPL", "B", "$42", "50"}};
    //        inventory = new String[][] {{"AAPL", "19"}};
    //        System.out.println(Arrays.deepToString(fractionalShares.updateInventory(orders,
    // inventory)));    //  [[AAPL, 35]]
    //
    ...
    //                new
    // String[][]{{"APPL","B","150","100"},{"APPL","B","40","100"},{"APPL","B","50","100"},{"GOOG","B","175","100"}},
    //                new String[][]{{"APPL", "00"},{"GOOG","00"}})));     //  [[GOOG, 25], [APPL,
    // 60]]
    //
