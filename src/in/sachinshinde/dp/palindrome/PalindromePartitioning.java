...
public class PalindromePartitioning {
  ...
  public static void backtrack(
      List<List<String>> subsets, List<String> tempList, String s, int start) {
    if (start == s.length()) subsets.add(new ArrayList<>(tempList));
    else {
  ...
  public static void main(String args[]) {
    ...
    for (List<String> tupple : ans) System.out.println(" " + tupple);
  }
}
