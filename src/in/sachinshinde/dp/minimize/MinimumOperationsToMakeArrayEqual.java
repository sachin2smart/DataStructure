...
public class MinimumOperationsToMakeArrayEqual {
    ...
    //	Video : https://youtu.be/9aGx9hoIBjI
	...
	MinimumOperationsToMakeArrayEqual arr = new MinimumOperationsToMakeArrayEqual();
	System.out.println(arr.minOperations(3));	//	2
	System.out.println(arr.minOperations(6));	//	9
	
	System.out.println(arr.minOperations2(3));	//	2
	System.out.println(arr.minOperations2(6));	//	9
    }
}
