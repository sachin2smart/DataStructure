...
public class MakeArrayStrictlyIncreasing {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        arr.makeArrayIncreasing(new int[] {1, 5, 3, 6, 7}, new int[] {1, 3, 2, 4})); // 1
    System.out.println(
        arr.makeArrayIncreasing(new int[] {1, 5, 3, 6, 7}, new int[] {4, 3, 1})); // 2
    System.out.println(
        arr.makeArrayIncreasing(new int[] {1, 5, 3, 6, 7}, new int[] {1, 6, 3, 3})); // -1

    System.out.println(
        arr.makeArrayIncreasing2(new int[] {1, 5, 3, 6, 7}, new int[] {1, 3, 2, 4})); // 1
    System.out.println(
        arr.makeArrayIncreasing2(new int[] {1, 5, 3, 6, 7}, new int[] {4, 3, 1})); // 2
    System.out.println(
        arr.makeArrayIncreasing2(new int[] {1, 5, 3, 6, 7}, new int[] {1, 6, 3, 3})); // -1

    System.out.println(
        arr.makeArrayIncreasing3(new int[] {1, 5, 3, 6, 7}, new int[] {1, 3, 2, 4})); // 1
    System.out.println(
        arr.makeArrayIncreasing3(new int[] {1, 5, 3, 6, 7}, new int[] {4, 3, 1})); // 2
    System.out.println(
        arr.makeArrayIncreasing3(new int[] {1, 5, 3, 6, 7}, new int[] {1, 6, 3, 3})); // -1

    System.out.println(
        arr.makeArrayIncreasing4(new int[] {1, 5, 3, 6, 7}, new int[] {1, 3, 2, 4})); // 1
    System.out.println(
        arr.makeArrayIncreasing4(new int[] {1, 5, 3, 6, 7}, new int[] {4, 3, 1})); // 2
    System.out.println(
        arr.makeArrayIncreasing4(new int[] {1, 5, 3, 6, 7}, new int[] {1, 6, 3, 3})); // -1
  }
  ...
  public int makeArrayIncreasing3(int[] arr1, int[] arr2) {
    ...
    for (int num : arr2) treeSet.add(num);
    ...
    while (!priorityQueue.isEmpty()) {
      ...
      if (idx == arr1.length - 1) return cnt;
      if (ans[idx] <= val) continue;
      ans[idx] = val;
      if (arr1[++idx] > val) priorityQueue.offer(new int[] {idx, cnt, arr1[idx]});
      Integer num = treeSet.higher(val);
      if (num != null) priorityQueue.offer(new int[] {idx, cnt + 1, num});
    }
    return -1;
  }
