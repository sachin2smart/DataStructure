...
public class LongestConsecutiveSequence {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        seq.longestConsecutiveBruteForce(new int[] {0, 3, 7, 2, 5, 8, 4, 6, 0, 1})); // 9

    System.out.println(seq.longestConsecutiveBySorting(new int[] {100, 4, 200, 1, 3, 2})); // 4

    System.out.println(
        seq.longestConsecutiveBySorting(new int[] {0, 3, 7, 2, 5, 8, 4, 6, 0, 1})); // 9

    System.out.println(seq.longestConsecutiveByHashSet(new int[] {100, 4, 200, 1, 3, 2})); // 	4

    System.out.println(
        seq.longestConsecutiveByHashSet(new int[] {0, 3, 7, 2, 5, 8, 4, 6, 0, 1})); // 	9

    System.out.println(seq.longestConsecutiveByTreeSet(new int[] {100, 4, 200, 1, 3, 2})); // 	4

    System.out.println(
        seq.longestConsecutiveByTreeSet(new int[] {0, 3, 7, 2, 5, 8, 4, 6, 0, 1})); // 	9

    System.out.println(seq.longestConsecutiveByHashMap(new int[] {1, 3, 2})); // 	4

    System.out.println(
        seq.longestConsecutiveByHashMap(new int[] {0, 3, 7, 2, 5, 8, 4, 6, 0, 1})); // 	9
  }
