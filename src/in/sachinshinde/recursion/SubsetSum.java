...
public class SubsetSum {
  ...
  private static void constructSumSubset(
      int index, int sum, ArrayList<Integer> arr, int n, ArrayList<Integer> sumSubset) {
    ...
    constructSumSubset(
        ...
        arr,
        n,
        sumSubset); //	at left recursion index increased, sum added
    constructSumSubset(
        index + 1, sum, arr, n, sumSubset); // 	at right right index increased, sum as is
  }
