...
public class PathWithMaximumMinimumValue {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        minPath.maximumMinimumPath(new int[][] {{5, 4, 5}, {1, 2, 6}, {7, 4, 6}})); // 4
    System.out.println(
        minPath.maximumMinimumPath2(new int[][] {{5, 4, 5}, {1, 2, 6}, {7, 4, 6}})); // 4

    System.out.println(
        minPath.maximumMinimumPath(new int[][] {{2, 2, 1, 2, 2, 2}, {1, 2, 2, 2, 1, 2}})); // 2
    System.out.println(
        minPath.maximumMinimumPath2(new int[][] {{2, 2, 1, 2, 2, 2}, {1, 2, 2, 2, 1, 2}})); // 2

    System.out.println(
        minPath.maximumMinimumPath(
            new int[][] {
              {3, 4, 6, 3, 4},
              {0, 2, 1, 1, 7},
              {8, 8, 3, 2, 7},
