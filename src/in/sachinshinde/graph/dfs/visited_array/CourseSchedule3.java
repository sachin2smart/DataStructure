...
public class CourseSchedule3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(courseSchedule3.scheduleCourse(new int[][]{{100,200},{200,1300},{1000,1250},{2000,3200}}));  // 3
        System.out.println(courseSchedule3.scheduleCourse(new int[][]{{1,2}})); //  1
        System.out.println(courseSchedule3.scheduleCourse(new int[][]{{3,2,},{4,3}}));  //  0
    }
}
