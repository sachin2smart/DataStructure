  ...
  */
  ...
  public static List<List<String>> getMergedAccounts(List<List<String>> accounts) {
    ...
    Map<String, TreeSet<String>> unions =
        new HashMap<>(); // used treeset here simply because the question requires the emails are
    ...
    //	parents: {johnnybravo@mail.com=johnnybravo@mail.com, johnsmith@mail.com=johnsmith@mail.com,
    // john00@mail.com=john00@mail.com, john_newyork@mail.com=john_newyork@mail.com,
    // mary@mail.com=mary@mail.com}
    //	owners : {johnnybravo@mail.com=John, johnsmith@mail.com=John, john00@mail.com=John,
    ...
    // parents : {johnnybravo@mail.com=johnnybravo@mail.com, johnsmith@mail.com=johnsmith@mail.com,
    // john00@mail.com=johnsmith@mail.com, john_newyork@mail.com=johnsmith@mail.com,
    // mary@mail.com=mary@mail.com}
    ...
    //	unions : {johnnybravo@mail.com=[johnnybravo@mail.com], johnsmith@mail.com=[john00@mail.com,
    // john_newyork@mail.com, johnsmith@mail.com], mary@mail.com=[mary@mail.com]}
