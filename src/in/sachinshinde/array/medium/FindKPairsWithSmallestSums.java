...
public class FindKPairsWithSmallestSums {
  public static void main(String[] args) {
    ...
    System.out.println(
        sums.kSmallestPairs(new int[] {1, 1, 2}, new int[] {1, 2, 3}, 2)); //  [[1, 1], [1, 1]]

    System.out.println(
        sums.kSmallestPairs2(
            new int[] {1, 7, 11}, new int[] {2, 4, 6}, 3)); //  [[1, 2], [1, 4], [1, 6]]
    System.out.println(
        sums.kSmallestPairs2(new int[] {1, 1, 2}, new int[] {1, 2, 3}, 2)); //  [[1, 1], [1, 1]]

    System.out.println(
        sums.kSmallestPairs3(
            new int[] {1, 7, 11}, new int[] {2, 4, 6}, 3)); //  [[1, 2], [1, 4], [1, 6]]
    System.out.println(
        sums.kSmallestPairs3(new int[] {1, 1, 2}, new int[] {1, 2, 3}, 2)); //  [[1, 1], [1, 1]]
  }
  ...
  public List<List<Integer>> kSmallestPairs2(int[] nums1, int[] nums2, int k) {
    ...
    for (int num : nums1) {
      pq.offer(
          new int[] {num + nums2[0], 0}); // The sum and the index of the second element in nums2
    }
