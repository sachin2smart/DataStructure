...
/*
        A wiggle sequence is a sequence where
            the differences between successive numbers strictly alternate between positive and negative.
...
public class WiggleSubsequence {
    ...
    public static void main(String[] args) {
        WiggleSubsequence seq = new WiggleSubsequence();
        System.out.println(seq.wiggleMaxLength(new int[]{1,7,4,9,2,5}));    // 6
        System.out.println(seq.wiggleMaxLength(new int[]{1,17,5,10,13,15,10,5,16,8}));  // 7
        System.out.println(seq.wiggleMaxLength(new int[] {1,2,3,4,5,6,7,8,9})); // 2
    }
}
