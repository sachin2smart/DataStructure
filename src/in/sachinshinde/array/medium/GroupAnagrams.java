...
public class GroupAnagrams {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        anagrams.groupAnagrams0(new String[] {"eat", "tea", "tan", "ate", "nat", "bat"}));
    System.out.println(
        anagrams.groupAnagrams3(new String[] {"eat", "tea", "tan", "ate", "nat", "bat"}));
  ...
  private String getAnagramKey(String s) {
    ...
    for (int i = 0; i < 26; i++) {
      if (count[i] != 0) {
        sb.append((char) ('a' + i))
            .append(count[i]); // a1e1t1  : here we are appending the count for chars
      }
    }
    return sb.toString();
  }
