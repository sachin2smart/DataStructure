...
public class LengthOfLongestSubArray {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        " {1,-1,2,0,-2,5,9} : " + subArray.maxLen(new int[] {1, -1, 2, 0, -2, 5, 9})); // 	5
    System.out.println(
        " {2,-2,5,-5,0,0,0,0,9} : "
            + subArray.maxLen(new int[] {2, -2, 5, -5, 0, 0, 0, 0, 9})); // 	8

    System.out.println("\n {2,0,-2} : " + subArray.maxLen2(new int[] {2, 0, -2})); // 	3
    System.out.println(" {1,2,3,4,5} : " + subArray.maxLen2(new int[] {1, 2, 3, 4, 5})); // 	0
    System.out.println(
        " {1,-1,2,0,-2,5,9} : " + subArray.maxLen2(new int[] {1, -1, 2, 0, -2, 5, 9})); // 	5
    System.out.println(
        " {2,-2,5,-5,0,0,0,0,9} : "
            + subArray.maxLen2(new int[] {2, -2, 5, -5, 0, 0, 0, 0, 9})); // 	8
  }
