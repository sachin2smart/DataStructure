...
public class MaximumSubArraySum {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        maximumSubArraySum.maxSubArray(new int[] {-2, 1, -3, 4, -1, 2, 1, -5, 4})); // 6
    ...
    System.out.println("-----------");
    System.out.println(
        maximumSubArraySum.maxSubArray2(new int[] {-2, 1, -3, 4, -1, 2, 1, -5, 4})); // 6
    ...
    System.out.println("-----------");
    System.out.println(
        maximumSubArraySum.maxSubArray3(new int[] {-2, 1, -3, 4, -1, 2, 1, -5, 4})); // 6
    ...
    System.out.println("-----------");
    System.out.println(
        maximumSubArraySum.maxSubArray4(new int[] {-2, 1, -3, 4, -1, 2, 1, -5, 4})); // 6
...
//	maximum sum at i'th index = max sum so far or dp[i] where dp[i] is nums[i] + previous index sum
// (if greater than 0)
