 ...
 * 	Its top and bottom edges are parallel to the X-axis, and 
...
public class RectangleOverlap {
	...
	System.out.println(rectangle.isRectangleOverlap(new int[] {0,0,2,2}, new int[] {1,1,3,3}));	// true
	System.out.println(rectangle.isRectangleOverlap(new int[] {0,0,1,1}, new int[] {1,0,2,1}));	// false
	System.out.println(rectangle.isRectangleOverlap(new int[] {0,0,2,2}, new int[] {2,2,3,3}));	// false
    }
}
