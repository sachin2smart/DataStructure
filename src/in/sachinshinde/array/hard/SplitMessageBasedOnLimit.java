...
public class SplitMessageBasedOnLimit {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        Arrays.toString(message.splitMessage("this is really a very awesome message", 9)));
    ...
    System.out.println(
        Arrays.toString(message.splitMessage1("this is really a very awesome message", 9)));
    //  "thi<1/14>","s i<2/14>","s r<3/14>","eal<4/14>","ly <5/14>","a v<6/14>","ery<7/14>","
    // aw<8/14>","eso<9/14>","me<10/14>"," m<11/14>","es<12/14>","sa<13/14>","ge<14/14>"

    System.out.println(
        Arrays.toString(
            message.splitMessage1("short message", 15))); //  "short mess<1/2>", "age<2/2>"
    System.out.println(
        Arrays.toString(
            message.splitMessage("short message", 15))); //  "short mess<1/2>", "age<2/2>"
  }
  ...
  public String[] splitMessage1(String message, int limit) {
    ...
    while ((messageLength + partitionLength + (3 + getStringLength(totalLength)) * totalLength)
        > (limit * totalLength)) {
