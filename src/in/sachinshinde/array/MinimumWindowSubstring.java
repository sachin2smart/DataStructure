...
public class MinimumWindowSubstring {
  ...
  public String minWindow(String s, String t) {
    ...
    Map<Character, Integer> currWindowCounts = new HashMap<Character, Integer>();
    ...
    while (r < s.length()) {
      ...
      if (hm.containsKey(c) && hm.get(c).intValue() == currWindowCounts.get(c).intValue()) formed++;
      ...
      while (l <= r && formed == required) {
        ...
        if (hm.containsKey(c) && hm.get(c).intValue() > currWindowCounts.get(c).intValue())
          formed--;
  ...
  public String minWindow2(String s, String t) {
    ...
    Map<Character, Integer> hm = new HashMap<Character, Integer>();
    for (int i = 0; i < t.length(); i++) hm.compute(t.charAt(i), (k, v) -> v == null ? 1 : v + 1);
