...
/*
        ...
        Follow-up: Can you implement both GetProduct and Add
...
public class ProductOfTheLastKNumbers {
    ...
    public static void main(String[] args) {
        ProductOfTheLastKNumbers product = new ProductOfTheLastKNumbers();
        product.add(3);
        product.add(0);
        product.add(2);
        product.add(5);
        product.add(4);
        System.out.println(product.getProduct(2));  //  20
        System.out.println(product.getProduct(3));  //  40
        System.out.println(product.getProduct(4));  //  0
        product.add(8);
        System.out.println(product.getProduct(2));  //  32
    }
