...
public class IntersectionOfTwoArrays {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        Arrays.toString(arr.intersection2(new int[] {1, 2, 2, 1}, new int[] {2, 2})));

    System.out.println(
        Arrays.toString(arr.intersection(new int[] {4, 9, 5}, new int[] {9, 4, 9, 8, 4})));
    System.out.println(
        Arrays.toString(arr.intersection2(new int[] {4, 9, 5}, new int[] {9, 4, 9, 8, 4})));
