...
public class FloorInBST {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "Ceil in tree for 14 is Node with key " + bst.getFloorInBST(root, 14)); // 	12
    System.out.println(
        "Ceil in tree for 15 is Node with key " + bst.getFloorInBST(root, 15)); // 	15
    System.out.println(
        "Ceil in tree for 35 is Node with key " + bst.getFloorInBST(root, 30)); // 	30
