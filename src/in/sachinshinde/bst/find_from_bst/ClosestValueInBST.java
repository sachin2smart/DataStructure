...
// When we recursively traversed then the closest value with be either to the root node of recursive
// call
//	or it will be at the childClosed node which is nothing but either left node or right node of
// recursive travered node
