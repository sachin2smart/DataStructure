...
public class MaximalSquare {
  ...
  public int maximalSquare(char[][] matrix) {
    ...
    for (int i = 0; i < rows; i++) for (int j = 0; j < cols; j++) maxSquareCacheMatrix[i][j] = -1;
    ...
    for (int i = 0; i < rows; i++)
      for (int j = 0; j < cols; j++)
        if (maxSquareCacheMatrix[i][j] > maxSquare) maxSquare = maxSquareCacheMatrix[i][j];
  ...
  private int constructMaxSquareCacheMatrix(
      int r, int c, int[][] maxSquareCacheMatrix, int rows, int cols, char[][] matrix) {
    ...
    if (maxSquareCacheMatrix[r][c] == -1) {
      ...
      int diagonal =
          constructMaxSquareCacheMatrix(r + 1, c + 1, maxSquareCacheMatrix, rows, cols, matrix);
