  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        cost.minPathCost(
            ...
            new int[][] {{9, 8}, {1, 5}, {10, 12}, {18, 6}, {2, 4}, {14, 3}})); // 17
  ...
  public int minPathCost_2(int[][] grid, int[][] moveCost) {
    ...
    for (int r = 1; r < m; r++) {
      for (int c = 0; c < n; c++) {
        ...
        for (int j = 0; j < n; j++) {
          minCostFromPeviousRow =
              Math.min(minCostFromPeviousRow, currCost[r - 1][j] + moveCost[grid[r - 1][j]][c]);
        }
