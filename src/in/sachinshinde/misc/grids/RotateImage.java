...
public class RotateImage {
    ...
    */
	...
	int[][] m1 = new int [][]{
	    ...
	    {7,8,9}};
	image.rotate(m1);
    //  image.rotate(m1);  rotate by 180 degree (apply rotate one more time)
    //  image.rotate(m1);  rotate by 270 degree (apply rotate one more time)
    //  image.rotate(m1);  rotate by 360 degree (gets original image)
	image.print(m1);
	/*
	 	7 4 1 
                8 5 2 
