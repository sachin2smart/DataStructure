...
public class Wordbreak2 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        wb2.wordBreak(
            "catsanddog", new ArrayList<String>(List.of("cat", "cats", "and", "sand", "dog"))));

    System.out.println(
        wb2.wordBreak(
            "pineapplepenapple",
            new ArrayList<String>(List.of("apple", "pen", "applepen", "pine", "pineapple"))));

    System.out.println(
        wb2.wordBreak("catanddog", new ArrayList<String>(List.of("cats", "sand", "and", "dogs"))));
  }
  ...
  private void dfs(
    ...
    if (index == s.length()) {
      if (currNode == root) finalList.add(String.join(" ", currentList));
      return;
    }
  ...
  private TrieNode2 buildTrie(List<String> wordDict) {
    ...
    for (String word : wordDict) {
      ...
      for (char ch : word.toCharArray()) {
        if (currNode.children[ch - 'a'] == null) currNode.children[ch - 'a'] = new TrieNode2();
