...
public class SkylineProblem {
  ...
  public List<List<Integer>> getSkyline4(int[][] buildings) {
    ...
    PriorityQueue<Integer> maxHeap =
        new PriorityQueue<>((b1, b2) -> buildings[b2][2] - buildings[b1][2]);
  ...
  public List<List<Integer>> mergeSkylines(
      List<List<Integer>> leftSkyline, List<List<Integer>> rightSkyline) {
