...
/*
	...
	Given two integer arrays gas and cost, 
		return the starting gas station's index if 
...
public class GasStation {
    ...
    public static void main(String[] args) {
		...
		System.out.println(gasStation.canCompleteCircuit(gas, cost));	//	3
		gas = new int[] {2,3,4};
		cost = new int[] {3,4,3};
		System.out.println(gasStation.canCompleteCircuit(gas, cost));	//	-1
		...
		System.out.println(gasStation.canCompleteCircuit2(gas, cost));	//	3
		gas = new int[] {2,3,4};
		cost = new int[] {3,4,3};
		System.out.println(gasStation.canCompleteCircuit2(gas, cost));	//	-1
		gas = new int[] {7, 1, 0, 11, 4};
		cost = new int[] {5, 9, 1, 2, 5};
		System.out.println(gasStation.canCompleteCircuit2(gas, cost));	//	3
	}
