...
public class NonOverlappingIntervals {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        intervals.eraseOverlapIntervals(new int[][] {{1, 2}, {2, 3}, {3, 4}, {1, 3}})); // 	1
    ...
    System.out.println(
        intervals.eraseOverlapIntervals_2(new int[][] {{1, 2}, {2, 3}, {3, 4}, {1, 3}})); // 	1
    System.out.println(
        intervals.eraseOverlapIntervals_2(new int[][] {{1, 2}, {1, 2}, {1, 2}})); // 	2
