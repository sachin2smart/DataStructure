...
public class TopKFrequentElements {
  public static void main(String[] args) {
    ...
    System.out.println(
        Arrays.toString(ele.topKFrequent2(new int[] {1, 1, 1, 2, 2, 3}, 2))); // [1,2]
    System.out.println(Arrays.toString(ele.topKFrequent2(new int[] {1}, 1))); // [1]

    System.out.println(
        Arrays.toString(ele.topKFrequent3(new int[] {1, 1, 1, 2, 2, 3}, 2))); // [1,2]
    System.out.println(Arrays.toString(ele.topKFrequent3(new int[] {1}, 1))); // [1]

    System.out.println(
        Arrays.toString(ele.topKFrequent4(new int[] {1, 1, 1, 2, 2, 3}, 2))); // [1,2]
  ...
  public int[] topKFrequent2(int[] nums, int k) {
    ...
    for (int i = 0; i < k; i++) res[i] = q.poll().getKey();
