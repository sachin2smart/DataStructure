...
public class SumOfTwoLinkedList {
  ...
  static ListNode addTwoLinkedLists(ListNode first, ListNode second) {
    ...
    while (first != null || second != null) {
      ...
      if (resultLinkedList == null) resultLinkedList = nextSumNode;
      else lastNodeOfCurrentSum.next = nextSumNode;
    ...
    if (carry > 0) lastNodeOfCurrentSum.next = new ListNode(carry);
