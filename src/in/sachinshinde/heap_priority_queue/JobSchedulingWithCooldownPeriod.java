...
public class JobSchedulingWithCooldownPeriod {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        JobSchedulingWithCooldownPeriod.getMinTimeRequired(tasksList, cooldownList)); // 	8
  }

  public static int getMinTimeRequired(List<Integer> tasks, int cooldown) {
    int timeSlots = 0;
    Map<Integer, Integer> cooldowns =
        new HashMap<>(); // Map to store the last execution time of each task
