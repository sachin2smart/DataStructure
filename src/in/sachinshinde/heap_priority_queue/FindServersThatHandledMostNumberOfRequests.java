...
public class FindServersThatHandledMostNumberOfRequests {
  ...
  public static void main(String[] args) {
    FindServersThatHandledMostNumberOfRequests servers =
        new FindServersThatHandledMostNumberOfRequests();
    System.out.println(
        servers.busiestServers(3, new int[] {1, 2, 3, 4, 5}, new int[] {5, 2, 3, 3, 3})); //  [1]
    System.out.println(
        servers.busiestServers(3, new int[] {1, 2, 3, 4}, new int[] {1, 2, 1, 2})); //  [0]
    System.out.println(
        servers.busiestServers(3, new int[] {1, 2, 3}, new int[] {10, 12, 11})); //  [0,1,2]
  }
