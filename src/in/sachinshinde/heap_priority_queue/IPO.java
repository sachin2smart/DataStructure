...
public class IPO {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        ipo.findMaximizedCapital(2, 0, new int[] {1, 2, 3}, new int[] {0, 1, 1})); // 4
    System.out.println(
        ipo.findMaximizedCapital(3, 0, new int[] {1, 2, 3}, new int[] {0, 1, 2})); // 6

    System.out.println(
        ipo.findMaximizedCapital2(2, 0, new int[] {1, 2, 3}, new int[] {0, 1, 1})); // 4
    System.out.println(
        ipo.findMaximizedCapital2(3, 0, new int[] {1, 2, 3}, new int[] {0, 1, 2})); // 6

    System.out.println(
        ipo.findMaximizedCapital3(2, 0, new int[] {1, 2, 3}, new int[] {0, 1, 1})); // 4
    System.out.println(
        ipo.findMaximizedCapital3(3, 0, new int[] {1, 2, 3}, new int[] {0, 1, 2})); // 6
  }
  ...
  public int findMaximizedCapital2(int k, int w, int[] profits, int[] capital) {
    ...
    PriorityQueue<Integer> minCapitalHeap =
        new PriorityQueue<>(n, (a, b) -> capital[a] - capital[b]);
    PriorityQueue<Integer> maxProfitsHeap =
        new PriorityQueue<>(n, (a, b) -> profits[b] - profits[a]);
  ...
  public int findMaximizedCapital3(int k, int w, int[] profits, int[] capital) {
    ...
    PriorityQueue<Integer> maxHeap =
        new PriorityQueue<>((a, b) -> b - a); // profits in decreasing order
