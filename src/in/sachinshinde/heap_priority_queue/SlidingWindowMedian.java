...
public class SlidingWindowMedian {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        Arrays.toString(
            slidingWindowMedian.medianSlidingWindow(
                ...
                3))); //  [1.00000,-1.00000,-1.00000,3.00000,5.00000,6.00000]
    System.out.println(
        Arrays.toString(
            slidingWindowMedian.medianSlidingWindow(
                new int[] {1, 2, 3, 4, 2, 3, 1, 4, 2},
                3))); //  [2.00000,3.00000,3.00000,3.00000,2.00000,3.00000,2.00000]

    System.out.println(
        Arrays.toString(
            slidingWindowMedian.medianSlidingWindow2(
                new int[] {1, 3, -1, -3, 5, 3, 6, 7},
                3))); //  [1.00000,-1.00000,-1.00000,3.00000,5.00000,6.00000]
    System.out.println(
        Arrays.toString(
    ...
    System.out.println(
        Arrays.toString(
            slidingWindowMedian.medianSlidingWindow3(
                new int[] {1, 3, -1, -3, 5, 3, 6, 7},
                3))); //  [1.00000,-1.00000,-1.00000,3.00000,5.00000,6.00000]
    System.out.println(
        Arrays.toString(
  ...
  public double[] medianSlidingWindow(int[] nums, int k) {
    ...
    TreeSet<Integer> low =
        new TreeSet<>((a, b) -> (nums[a] != nums[b] ? Integer.compare(nums[a], nums[b]) : a - b));
    TreeSet<Integer> high =
        new TreeSet<>((a, b) -> (nums[a] != nums[b] ? Integer.compare(nums[a], nums[b]) : a - b));
  ...
  private void addElement(
      PriorityQueue<Integer> smallNums, PriorityQueue<Integer> largeNums, int n) {
    smallNums.offer(n);
