...
public class ReferralLeaderboard {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        Arrays.toString(
            referralLeaderboard.getLeaderboard(
                new String[] {"A", "B", "C"}, new String[] {"B", "C", "D"})));
    System.out.println(
        Arrays.toString(
            referralLeaderboard.getLeaderboard2(
                new String[] {"A", "B", "C"}, new String[] {"B", "C", "D"})));
  }
  ...
  public String[] getLeaderboard(String[] rh_users, String[] new_users) {
    ...
    while (!pq.isEmpty()) {
      ...
      if (curr.getValue() != null
          && Arrays.stream(rh_users).anyMatch(r -> r.equals(curr.getKey().user))) {
  ...
  public String[] getLeaderboard2(String[] referrers, String[] referees) {
    ...
    PriorityQueue<User> pq =
        new PriorityQueue<>(
            (a, b) -> a.count == b.count ? a.name.compareTo(b.name) : b.count - a.count);
