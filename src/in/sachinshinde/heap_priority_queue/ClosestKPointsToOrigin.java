...
public class ClosestKPointsToOrigin {
  public static void main(String[] args) {
    ...
    System.out.println(
        Arrays.deepToString(
            closestKPointsToOrigin.kClosest(new int[][] {{1, 3}, {-2, 2}}, 1))); // 	[[-2, 2]]
    System.out.println(
        Arrays.deepToString(
            closestKPointsToOrigin.kClosest(
                new int[][] {{3, 3}, {5, -1}, {-2, 4}}, 2))); // 	[[3, 3], [-2, 4]]

    //	Arrays.sort, Arrays.copyOfRange : O(NlogN)
    System.out.println(
        Arrays.deepToString(
            closestKPointsToOrigin.kClosest2(new int[][] {{1, 3}, {-2, 2}}, 1))); // 	[[-2, 2]]
    System.out.println(
        Arrays.deepToString(
            closestKPointsToOrigin.kClosest2(
                new int[][] {{3, 3}, {5, -1}, {-2, 4}}, 2))); // 	[[3, 3], [-2, 4]]

    //	QuickSort : O(N)
    System.out.println(
        Arrays.deepToString(
            closestKPointsToOrigin.kClosest3(new int[][] {{1, 3}, {-2, 2}}, 1))); // 	[[-2, 2]]
    System.out.println(
        Arrays.deepToString(
            closestKPointsToOrigin.kClosest3(
                new int[][] {{3, 3}, {5, -1}, {-2, 4}}, 2))); // 	[[3, 3], [-2, 4]]
  }
